...
class FundrazrSpider(scrapy.Spider):
    ...
    def parse_dir_contents(self, response):
      ...
      item['endDate'] = "".join(response.xpath("//div[contains(@id, 'campaign-stats')]//span[contains(@class,'stats-label lowercase')]/span[@class='stat']/text()").extract()).strip()
